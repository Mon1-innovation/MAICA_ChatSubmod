...
init 999 python:
    ...
    @store.mas_submod_utils.functionplugin("ch30_loop", priority=-100)
    def push_mspire():
        if try_eval(mas_getEV("maica_mspire").conditional) and not mas_inEVL("maica_mspire") and store.mas_getAPIKey("Maica_Token") != "" and len(mas_rev_unseen) == 0 and persistent.maica_setting_dict.get('mspire_enable'):
