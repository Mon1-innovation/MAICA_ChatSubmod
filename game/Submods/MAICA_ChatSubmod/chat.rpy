...
init 5 python:
    addEvent(
        Event(
            ...
            category=[_("You"), _("Us"), _("Submods"), "MAICA"],
            pool=True,
            random=False,
            unlocked=False,
            aff_range=(mas_aff.HAPPY, None)
...
init 5 python:
    addEvent(
        Event(
            ...
            category=[_("You"), _("Us"), _("Submods"), "MAICA"],
            prompt=_("About additional preferences"),
            random=False,
            pool=True,
...
m 1eub "What do you say, [player]? {w=0.3}You like this place?{nw}"
    ...
    menu:
        ...
        "Actually..." if persistent._mas_pm_likes_nature is False:
...
label maica_delete_information:
    ...
    call screen mas_check_scrollable_menu(items, mas_ui.SCROLLABLE_MENU_TXT_MEDIUM_AREA, mas_ui.SCROLLABLE_MENU_XALIGN, selected_button_prompt=_("Delete item"), return_all=True)
