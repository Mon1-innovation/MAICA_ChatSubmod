...
label mtrigger_youtubemusic_search(keyword):
    ...
    label mtrigger_youtubemusic_search.input_loop:
        ...
        if lower_search_request == "":
            ...
            if ytm_utils.is_youtube_url(raw_search_request):
                ...
                if (
                    ...
                    label mtrigger_youtubemusic_search.reaction_your_reality:
                    ...
                    label mtrigger_youtubemusic_search.reaction_ily:
                ...
                label mtrigger_youtubemusic_search.menu_display:
                    if menu_list:
                        ...
                        if isinstance(_return, ytm_utils.VideoInfo):
                            call mtrigger_youtubemusic_search.ytm_process_audio_info (_return.url, add_to_search_hist=False, add_to_audio_hist=True)
                            if not _return:
                                jump mtrigger_youtubemusic_search.menu_display
                            ...
                            m 1eub "Alright!"
                            jump mtrigger_youtubemusic_search.input_loop
                        else:
